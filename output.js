//Wed Aug 27 2025 09:30:14 GMT+0000 (Coordinated Universal Time)
...
function _0x1dec3f(_0x4836b8, _0x22e470 = "") {
  try {
    ...
    return _0x1bde61(_0x47fe73, {
      "stdio": "inherit"
    }), console.log("✅ " + _0x1bab79 + " 安装成功"), true;
  } catch (_0x1934e5) {
    return console.log("❌ " + _0x4836b8 + " 安装失败: " + _0x1934e5.message), false;
  }
}
      ...
      if (_0x5804b9) {
        ...
        if (_0x1dec3f(_0x1f934d, _0x1fd44a)) {
          try {
            ...
            return console.log("❌ " + _0x1f934d + " 加载失败: " + _0x41391f.message), null;
          }
        }
      }
    } else {
...
function _0x39f05c(_0x110909, _0x518328, _0x2be2e1) {
  const _0xa43d3f = "\x1B[90m" + _0x42c039() + "[0m",
    _0x28ddb0 = "\x1B[36m" + _0x518328 + "[0m";
  if (_0x253e3c === "emoji") {
...
async function _0x38e8c3({
    ...
    try {
      ...
      if (_0x2ca9d2.status === 200) {
        ...
        if (_0x431687 === false) {
          ...
          return _0x362ef8("签名", _0xfe92c9), null;
        }
      }
    } catch (_0x7cfcf8) {
  ...
  return console.log("⏰ 队列 " + _0x52029d + " 轮询超时，总耗时: " + _0x14fb6f + "ms，最大等待时间: " + maxWaitMs + "ms"), _0x362ef8("签名", "队列处理超时"), null;
}
...
function _0x494deb(_0x1f5b86) {
  ...
  if (!_0x56177c) {
    return console.log("⚠️ 代理功能不可用，将使用直连模式"), _0x362c66();
  }
  try {
    ...
    return console.log("⚠️ 代理创建失败，将使用直连模式"), _0x362c66();
  }
}
...
class _0x33a232 {
  ...
  async ["User_info"](_0xf57573 = true) {
    ...
    try {
      ...
      return this.log("用户信息获取失败: " + JSON.stringify(_0x33a334)), false;
    } catch (_0x57abd5) {
      return this.log("用户信息获取异常: " + _0x57abd5.message), false;
    }
  }
  async ["Treasure_Box"]() {
  ...
  async ["Event_Report"](_0x136318) {
    ...
    try {
      ...
      return this.log("事件上报异常: " + _0x59a807.message), {};
    }
  }
  async ["Task_Report"](_0x2af252, _0x4de196, _0x1e31cb) {
    ...
    try {
      ...
      return this.log("任务上报异常: " + _0xb82c28.message), null;
    }
  }
  ...
  async ["GetAd"](_0x9d587b) {
    ...
    try {
      ...
      return this.log("获取广告信息异常: " + _0x2d0722.message), [];
    }
  }
  ...
  async ["WatchAD"]() {
    ...
    try {
      ...
      return this.log("观看广告任务异常: " + _0x4ba2b3.message), false;
    }
    return true;
  }
    ...
    try {
      ...
      if (_0x1c8695?.["result"] === 1) {
        ...
        try {
          ...
          return this.log("广告响应解析失败: " + _0x377a89.message), false;
        }
      ...
      return this.log("观看宝箱广告任务异常: " + _0x2206fc.message), false;
    }
    return true;
  }
  async ["main"]() {
